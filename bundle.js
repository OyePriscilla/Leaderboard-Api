...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://webpackconfig/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://webpackconfig/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://webpackconfig/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://webpackconfig/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getData\": () => (/* binding */ getData),\n/* harmony export */   \"postData\": () => (/* binding */ postData)\n/* harmony export */ });\n/* harmony import */ var _apiUrl_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./apiUrl.js */ \"./src/modules/apiUrl.js\");\n\n\nconst getData = async () => {\n  const res = await fetch(_apiUrl_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n  const data = await res.json();\n  return data.result;\n};\n\nconst postData = async (name, score) => {\n  await fetch(_apiUrl_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"], {\n    method: 'POST',\n    body: JSON.stringify({\n      user: name,\n      score,\n    }),\n    mode: 'cors',\n    headers: {\n      'Content-type': 'application/json; charset=UTF-8',\n    },\n  });\n};\n\n\n\n\n//# sourceURL=webpack://webpackconfig/./src/modules/apiData.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst baseUrl = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/YgOHNkpJPFaxmh266S3Q/scores/';\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (baseUrl);\n\n//# sourceURL=webpack://webpackconfig/./src/modules/apiUrl.js?");
